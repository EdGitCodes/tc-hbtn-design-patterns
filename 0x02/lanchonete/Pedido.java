...
public class Pedido {
    ...
    public String toString() {
        ...
        getItensForaCaixa().stream().sorted(new ItemPedido()).forEach(itemPedido -> itensForaDaCaixa
                .append(String.format("\t\t- %s %s\n", itemPedido.getTipo(), itemPedido.getNome())));
        getItensDentroCaixa().stream().sorted(new ItemPedido()).forEach(itemPedido -> itensDentroDaCaixa
                .append(String.format("\t\t- %s %s\n", itemPedido.getTipo(), itemPedido.getNome())));
